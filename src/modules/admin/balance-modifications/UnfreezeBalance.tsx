...
export function UnfreezeBalance() {
  ...
  const handleUnfreezeBalance = async () => {
    ...
    try {
      setIsLoading(true);
      const response = await ApiUnfreezeBalance({
        organizationId,
      ...
      if (response.ok) {
        ...
        toast({
          title: "餘額解凍成功",
          description: `已為組織 ${organizationId} 解凍 ${formatNumber(
            amount
          )} ${paymentMethod}`,
          variant: "success",
        });
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>餘額解凍操作已成功完成</DialogDescription>
          </DialogHeader>
          <DialogFooter>
