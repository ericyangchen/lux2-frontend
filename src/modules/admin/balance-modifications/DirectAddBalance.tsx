...
export function DirectAddBalance() {
  ...
  const handleAddBalance = async () => {
    ...
    try {
      setIsLoading(true);
      const response = await ApiDirectModifyAddBalance({
        organizationId,
  ...
  return (
    <>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>加值成功</DialogTitle>
            <DialogDescription>餘額加值操作已成功完成</DialogDescription>
          </DialogHeader>
          <DialogFooter>
